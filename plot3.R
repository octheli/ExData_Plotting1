plot3 <- function() {
## Draw plot3.png for the Project 1 of the course Exploratory Data Analysis.
...
## Set up the output "plot3.png" file with a width of 480 pixels and a height of 480 pixels.
  png(filename = "plot3.png", width = 480, height = 480, units = "px")
  
## Plot "Sub_metering_1".
  with(powerConsumption, plot(datetime, Sub_metering_1, type = "l", xlab = "",
