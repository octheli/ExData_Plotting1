plot2 <- function() {
## Draw plot2.png for the Project 1 of the course Exploratory Data Analysis.
...
## Set up the output "plot2.png" file with a width of 480 pixels and a height of 480 pixels.
